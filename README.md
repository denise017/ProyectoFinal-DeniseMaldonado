**Proyecto Final QA Testing — Pinterest Lite**

**Integrante:** Denise Maldonado

**Objetivo del Testing:**
  El objetivo de este proyecto es aplicar de manera practica los conocimientos de testing adquiridos en el curso, analizando funcionalidades críticas de Pinterest Lite, diseñando y ejecutando casos de prueba funcionales con sus criterios de aceptación, documentando errores con evidencia, integrando pruebas de API y utilizando GitHub pra versionado y colaboracion, con el fin de evaluar la calidad del producto y proponer mejoras para su correcta funcionalidad.
